...
describe('normalizeDrivers', () => {
  ...
  it('keeps the first row for duplicated live positions', () => {
    const result = normalizeDrivers([
      { position: 1, kart: '20', name: 'Eduardo', time: '01:16.364' },
      { position: 2, kart: '59', name: 'Lucas', time: '+00:17.598' },
      { position: 1, kart: '20', name: 'Eduardo duplicate', time: '01:16.364' },
    ]);
