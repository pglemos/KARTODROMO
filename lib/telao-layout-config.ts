...
export const TELAO_LAYOUT_PRESETS: Record<string, TelaoLayoutConfig> = {
  ...
  'tb50-live-21': {
    ...DEFAULT_TELAO_LAYOUT,
    id: 'tb50-live-21',
    label: 'TB50 21 pilotos - dados reais',
    columns: 7,
    rows: 3,
  ...
  'tb50-live-20': {
    ...DEFAULT_TELAO_LAYOUT,
    id: 'tb50-live-20',
    label: 'TB50 20 pilotos - dados reais',
    columns: 10,
    rows: 2,
    positionFontSize: 28,
    kartFontSize: 42,
...
export function normalizeTelaoLayoutConfig(value: unknown): TelaoLayoutConfig {
  ...
  return {
    ...
    positionFontSize: clamp(input.positionFontSize, 10, 250, base.positionFontSize),
    kartFontSize: clamp(input.kartFontSize, 10, 250, base.kartFontSize),
    nameFontSize: clamp(input.nameFontSize, 0, 80, base.nameFontSize),
    timeFontSize: clamp(input.timeFontSize, 0, 80, base.timeFontSize),
    ...
    lineWidth: clamp(input.lineWidth, 0, 8, base.lineWidth ?? 1),
    colors: {
