...
$AutostartScript = Join-Path $PSScriptRoot "start-udk-bridge-autostart.ps1"
...
Register-ScheduledTask `
  ...
  -Principal $principal `
  -Settings $settings `
  -Description "Starts the UDK Bridge (LapTime ULTRAS -> UDK draft) at Windows boot without requiring user logon." `
  -Force | Out-Null
