...
const CONFIG = {
  server: process.env.LAPTIME_SQL_SERVER || '192.168.20.254',
  options: { instanceName: process.env.LAPTIME_SQL_INSTANCE || 'LAPTIME', encrypt: false, trustServerCertificate: true },
  database: process.env.LAPTIME_SQL_DATABASE || 'LapTime',
  user: process.env.LAPTIME_SQL_USER || 'LapTimeSql',
